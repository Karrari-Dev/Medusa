...
بعد از اجرای دستور `medusa`، منویی باز می‌شود. برای ساخت و راه‌اندازی تانل مراحل زیر را انجام دهید:

1️⃣ **Start / Configure**  
- مشخص کنید سرور شما **ایران** است یا **خارج**.  
- حالت تونل را انتخاب کنید: **Direct** یا **Reverse**.  

2️⃣ **Direct Mode**  
- **ایران:** پورت، رمز، آی‌پی سرور خارج و نوع پروتکل (TCP/UDP/هر دو) را وارد کنید.  
- **خارج:** فقط پورت و رمز را وارد کنید.  

3️⃣ **Reverse Mode**  
- **خارج:** پورت، رمز، آی‌پی سرور ایران و نوع پروتکل (TCP/UDP/هر دو) را وارد کنید.  
- **ایران:** فقط پورت و رمز را وارد کنید.  

⚡️ **نکته مهم:** در هر دو حالت (Direct یا Reverse)، رمز و پورت‌ها باید روی هر دو سرور دقیقاً یکسان باشند.  

با پایان این مراحل، تانل بین سرور ایران و خارج ساخته می‌شود و آماده استفاده است 🚀
